    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">Article</li>
            </ol>
            <h6 class="font-weight-bolder text-white mb-0">Article</h6>
                ...
                <div class="card" id="basic-info">
                    ...
                    <div class="card-body">
                        <div class="card m-3 p-5">
                            <img src="/articleImages/{{ $article->image }}" width="300" alt="{{ $article->titre }}">
                            <h3>{{ $article->nom }} </h3>
